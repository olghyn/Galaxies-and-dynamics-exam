...
/*  1)COMPUTE THE FORCE PER UNIT MASS ON THE PARTICLE DISTANT r FROM THE CENTER -> acc_h
 *  2)COMPUTE THE VERSOR r -> versor_r
 *  3)USE ADDMULVS2(acc0, dr, mr3i, versor_r, acc_h); INSTEAD OF ADDMULVS(acc0, dr, mr3i);
 */
